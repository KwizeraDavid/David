			...
			<div id="section-1" class="section">
			    <div id="top" class="callbacks_container">
			      <ul class="rslides" id="slider4">
			        <li>
			          <img src="images/cynthiabutare1 (4).jpg" alt="">
					  <div class="caption">
			        ...
			        <li>
			          <img src="images/herve_ir1 (1).jpg" alt="">
			        <div class="caption">
			          	<div class="header-info">
			        ...
			        <li>
			          <img src="images/herve_ir1 (3).jpg" alt="">
			          <div class="caption">
			          	<div class="header-info">
							<h2><a href="#">Get Away On This Weekend</a></h2>
							<lable></lable>
					...
					<li>
			          <img src="images/herve_ir1 (4).jpg" alt="">
			          <div class="caption">
			          	<div class="header-info">
                    ...
                    <li>
			          <img src="images/cynthiabutare1 (6).jpg" alt="">
			          <div class="caption">
			          	<div class="header-info">
