   ...
   <div class="top-tours-head text-center">
	     ...
	     <div id="portfoliolist">
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/cynthiabutare1 (3).jpg" class="img-responsive" alt=""/></a>
							</div>
					</div>
					<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/serenityadventure1 (7).jpg" class="img-responsive" alt=""/></a>
                             </div>
					</div>
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/serenityadventure1 (8).jpg" class="img-responsive" alt=""/></a>
					...
					<div class="portfolio icon mix_all" data-cat="icon" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/cynthiabutare1 (4).jpg" class="img-responsive" alt=""/></a>
...
<div class="tour-guides section" id="section-4" >
	  <div class="tour-guides-head text-center">
		  ...
		  <span></span><img src="" alt=""><span></span>
		  <div class="container">
				<p>We help you  decide what you want to do, whether it's a general tour of a city, a day of hiking, or visiting remote villages in the countryside. Have a ball-park time allotment in mind, whether it's a half-day, a full-day, or a multi-day experience. Once you have chosen a guide, you'll probably refine your ideas based upon the guide's knowledge.</p>
		  </div>
	  </div>
	  <div class="container">
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/sharama_tours1 (3).jpg" width="300px" height="150px" >

					 <p><a href="https://sharamatours.com/">Brought To You By Sharama Tours</a></p>
				 </div>
				<?php if($n%4==3)
				{?>
            </div>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">Citybuddiz</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+250) 789479116&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;784506326</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">www.citybuddiz.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;www.citybuddiz.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>LOCATION</h5>
                        <br/>
